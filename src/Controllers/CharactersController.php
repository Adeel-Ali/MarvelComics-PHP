...
class CharactersController extends BaseController {
                ...
                $characterId) 
    {
        ...
        return $mapper->map($response->body, new Models\Character());
    }
     ...
     * @param  string     $events             Optional parameter: Return only characters which appear in the specified events (accepts a comma-separated list of ids).
     * @param  string     $limit              Optional parameter: Limit the result set to the specified number of resources.
