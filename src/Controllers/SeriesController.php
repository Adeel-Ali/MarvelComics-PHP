...
class SeriesController extends BaseController
{
     ...
     *
     * @param object $seriesId Filter by series title.
    ...
    public function getSeriesIndividual(
        ...
        return $mapper->mapClass($response->body, 'MarvelComicsLib\\Models\\Series');
    }
     ...
     *
     * @param object $title           (optional) Return only series matching the specified title.
