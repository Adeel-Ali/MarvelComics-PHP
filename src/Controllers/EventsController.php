...
class EventsController extends BaseController
{
     ...
     *
     * @param object $eventId A single event.
    ...
    public function getEventIndividual(
        ...
        return $mapper->mapClass($response->body, 'MarvelComicsLib\\Models\\Event');
    }
     ...
     *
     * @param object $name           (optional) Return only events which match the specified name.
     ...
     *                               comma-separated list of ids).
     * @param object $stories        (optional) Return only events which take place in the specified stories (accepts a
     *                               comma-separated list of ids).
     * @param object $orderBy        (optional) Order the result set by a field or fields. Add a "-" to the value sort
     *                               in descending order. Multiple values are given priority in the order in which they
