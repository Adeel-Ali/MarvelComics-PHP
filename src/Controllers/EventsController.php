...
class EventsController extends BaseController {
     ...
     * @param  string     $noVariants            Optional parameter: Exclude variant comics from the result set. (Acceptable values are: "true")
     * @param  string     $offset                Optional parameter: Skip the specified number of resources in the result set.
     ...
     * @param  string     $sharedAppearances     Optional parameter: Return only comics in which the specified characters appear together (for example in which BOTH Spider-Man and Wolverine appear).
     ...
     * @param  string     $limit               Optional parameter: Limit the result set to the specified number of resources.
     * @param  string     $modifiedSince       Optional parameter: Return only series which have been modified since the specified date.
     * @param  string     $offset              Optional parameter: Skip the specified number of resources in the result set.
     * @param  string     $orderBy             Optional parameter: Order the result set by a field or fields. Add a "-" to the value sort in descending order. Multiple values are given priority in the order in which they are passed. (Acceptable values are: "title", "modified", "startYear", "-title", "-modified", "-startYear")
     * @param  string     $seriesType          Optional parameter: Filter the series by publication frequency type. (Acceptable values are: "collection", "one shot", "limited", "ongoing")
     * @param  string     $startYear           Optional parameter: Return only series matching the specified start year.
     * @param  string     $stories             Optional parameter: Return only series which contain the specified stories (accepts a comma-separated list of ids).
     * @param  string     $title               Optional parameter: Filter by series title.
     * @param  string     $titleStartsWith     Optional parameter: Return series with titles that begin with the specified string (e.g. Sp).
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     * @param  string     $name               Optional parameter: Return only events which match the specified name.
     ...
     * @param  string     $stories            Optional parameter: Return only events which take place in the specified stories (accepts a comma-separated list of ids).
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
