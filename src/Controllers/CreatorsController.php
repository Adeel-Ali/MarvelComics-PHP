...
class CreatorsController extends BaseController {
                ...
                $creatorId) 
    {
        ...
        return $mapper->map($response->body, new Models\Creator());
    }
     ...
     * @param  string     $comics            Optional parameter: Return only stories contained in the specified comics (accepts a comma-separated list of ids).
