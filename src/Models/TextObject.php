...
class TextObject implements JsonSerializable
{
     ...
     * @required
     * @var object $language public property
     */
    public $language;
     ...
     * The text.
     * @required
     * @var object $text public property
     */
    public $text;
     ...
     * @param object $language Initialization value for $this->language
     * @param object $text     Initialization value for $this->text
     */
