...
class CreatorList implements JsonSerializable {
     ...
     * @param   integer           $available       Initialization value for the property $this->available    
     ...
     * @param   integer           $returned        Initialization value for the property $this->returned     
     */
